"""Regression checks for the ion-sim-scheduler-lab casebook."""
...
from casebook.harness import assert_expected, ion_sim_scheduler_lab_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(ion_sim_scheduler_lab_summary(), assert_expected())
