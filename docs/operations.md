...
`ion-sim-scheduler-lab` is centered on simulations work in C#. The technical target is: Create a C# reference implementation for scheduler workflows, centered on visual model generation, layout fixtures, and stable geometry snapshots.
...
The score is deterministic. The current threshold is 162. Risk has a penalty of 4, latency has a penalty of 2, and weight contributes a bonus of 3.
